...
from src.training_model.ffnn.gen_data_helpers.flop_level_data import FlopLevelData
from src.training_model.ffnn.gen_data_helpers.model_level_data import (
    ModelLevelData,
)
